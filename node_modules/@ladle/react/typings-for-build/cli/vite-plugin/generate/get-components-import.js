...
const getComponents = (configFolder) => {
    ...
    const firstFoundComponentsPath = componentsPaths.find((componentsPath) => fs.existsSync(componentsPath));
