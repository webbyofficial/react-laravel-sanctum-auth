 ...
 * @param {any} astPath
 */
const getNamedExports = ({ fileId, exportDefaultProps, namedExportToMeta, namedExportToStoryName, storyParams, stories, entry, }, astPath) => {
    /**
     * @type {string}
     */
    let namedExport = "";
    ...
    if (namedExport.includes("__")) {
        throw new Error(`Story named ${namedExport} can't contain "__". It's reserved for internal encoding. Please rename this export.`);
    }
