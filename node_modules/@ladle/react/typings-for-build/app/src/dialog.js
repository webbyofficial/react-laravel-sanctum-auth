...
let checkStyles = noop;
{
    ...
    const _ref$1 = typeof process !== "undefined"
        ? process
        : {
            env: {
...
function useForceUpdate() {
    const _React$useState2 = react.useState(Object.create(null)), dispatch = _React$useState2[1];
...
const Portal = function Portal(_ref) {
    const children = _ref.children, _ref$type = _ref.type, type = _ref$type === void 0 ? "reach-portal" : _ref$type;
    ...
    useIsomorphicLayoutEffect(function () {
        ...
        if (!mountNode.current)
            return; // It's possible that the content of the portal has, itself, been portaled.
            ...
            if (has$1(typeSpecs, typeSpecName)) {
                ...
                try {
                    ...
                    if (typeof typeSpecs[typeSpecName] !== "function") {
                        const err = Error((componentName || "React class") +
                            ": " +
                            location +
                            " type `" +
                            typeSpecName +
                ...
                if (error && !(error instanceof Error)) {
                    printWarning$1((componentName || "React class") +
...
const factoryWithTypeCheckers = function (isValidElement, throwOnDirectAccess) {
        ...
        function checkType(isRequired, props, propName, componentName, location, propFullName, secret) {
            ...
            if (secret !== ReactPropTypesSecret_1) {
                if (throwOnDirectAccess) {
                    ...
                    const err = new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. " +
    ...
    function createEnumTypeChecker(expectedValues) {
        if (!Array.isArray(expectedValues)) {
            {
                if (arguments.length > 1) {
                    printWarning("Invalid arguments supplied to oneOf, expected an array, got " +
                        arguments.length +
                        " arguments. " +
...
const mediumFocus = createMedium({}, function (_ref) {
    const target = _ref.target, currentTarget = _ref.currentTarget;
    return {
        target: target,
...
const FocusLock = /*#__PURE__*/ react.forwardRef(function FocusLockUI(props, parentRef) {
    ...
    const _React$useState2 = react.useState({}), id = _React$useState2[0]; // SIDE EFFECT CALLBACKS
    const onActivation = react.useCallback(function () {
    ...
    const onDeactivation = react.useCallback(function () {
        isActive.current = false;
        if (onDeactivationCallback) {
            onDeactivationCallback(observed.current);
        }
    }, [onDeactivationCallback]);
    const returnFocus = react.useCallback(function (allowDefer) {
...
const notHiddenInput = function (node) {
    return !((node.tagName === "INPUT" || node.tagName === "BUTTON") &&
...
const newFocus = function (innerNodes, outerNodes, activeElement, lastNode) {
    ...
    const correctedIndexDiff = correctedNodes.indexOf(activeElement) -
...
const RemoveScroll = react.forwardRef(function (props, parentRef) {
    ...
    return react.createElement(react.Fragment, null, enabled &&
...
function RemoveScrollSideCar(props) {
    ...
    return react.createElement(react.Fragment, null, inert ? react.createElement(Style, { styles: generateStyle(id) }) : null, removeScrollBar
...
const DialogOverlay = /*#__PURE__*/ forwardRefWithAs(function DialogOverlay(_ref, forwardedRef) {
    const _ref$as = _ref.as, Comp = _ref$as === void 0 ? "div" : _ref$as, _ref$isOpen = _ref.isOpen, isOpen = _ref$isOpen === void 0 ? true : _ref$isOpen, props = _objectWithoutPropertiesLoose(_ref, ["as", "isOpen"]);
...
var DialogInner = /*#__PURE__*/ forwardRefWithAs(function DialogInner(_ref2, forwardedRef) {
    ...
    const activateFocusLock = react.useCallback(function () {
...
const Dialog = /*#__PURE__*/ forwardRefWithAs(function Dialog(_ref4, forwardedRef) {
    const _ref4$allowPinchZoom = _ref4.allowPinchZoom, allowPinchZoom = _ref4$allowPinchZoom === void 0 ? false : _ref4$allowPinchZoom, initialFocusRef = _ref4.initialFocusRef, isOpen = _ref4.isOpen, _ref4$onDismiss = _ref4.onDismiss, onDismiss = _ref4$onDismiss === void 0 ? noop : _ref4$onDismiss, props = _objectWithoutPropertiesLoose(_ref4, [
        "allowPinchZoom",
        "initialFocusRef",
        "isOpen",
        "onDismiss",
...
function createAriaHider(dialogNode) {
    ...
    Array.prototype.forEach.call(ownerDocument.querySelectorAll("body > *"), function (node) {
        ...
        const portalNode = (_dialogNode$parentNod = dialogNode.parentNode) == null
            ? void 0
...
function ariaLabelType(props, propName, compName, location, propFullName) {
    ...
    if (props["aria-label"] && props["aria-labelledby"]) {
        return new Error("You provided both `aria-label` and `aria-labelledby` props to a <" +
            compName +
